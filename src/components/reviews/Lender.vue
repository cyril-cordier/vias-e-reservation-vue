        ...
        >
          <table class="min-w-full">
            <thead>
              <tr>
                <th
                  class="px-6 py-3 border-b border-blue-200 bg-orange-200 text-xs leading-4 font-semibold text-blue-600 uppercase tracking-wider text-center"
                >
                 Nom de Préteur
                </th>
                <th
            ...
            <tbody class="bg-white">
              ...
              <tr >
                <td
                  class="px-6 py-2 whitespace-no-wrap border-b text-center border-blue-200"
                >
                ...
                <td
                  class="px-6 py-2 whitespace-no-wrap border-b border-blue-200"
                >
                ...
                <td
                  class="px-6 py-2 whitespace-no-wrap border-b border-blue-200 text-center"
                >
                  <span
