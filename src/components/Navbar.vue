<template>
    <header class="bg-blue-200 md:flex md:justify-between md:items-center md:pl-2 md:pr-4 md:py-2">
        <div class="flex items-center justify-between pl-2 pr-4 py-2 md:pl-0 md:pr-0 md:py-0">
            ...
            <div class="md:hidden">
                <button @click="isOpen = !isOpen" type="button"
                    class="block text-blue-500 hover:text-blue-700 focus:text-blue-700 focus:outline-none">
