        ...
        Details du jeu</router-link>
                ...
                >
                  <p
                    ...
                    >{{reservation.ownerId.username}} a accepté de vous prêter<br>{{reservation.gameId.name}}</p>
            ...
            <!-- <form class="w-1/2 border p-3 bg-gray-200 rounded mx-auto">
                <label class="block text-gray-700 text-lg font-bold mb-2 text-center" for="nomdujeu">
                Votre jeu XXXXXX intéresse quelqu'un !
                </label>
                 <textarea
                 class="text-center shadow appearance-none border rounded w-full h-64 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                 type="text"
                 id="msgborrower"
                 >
                 Bonjour XXXXX,                
